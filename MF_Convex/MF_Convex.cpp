...
void proximal (Tensor4D& W_1, Tensor4D& W_2, Tensor4D& Y, double rho, SequenceSet& allSeqs, vector<int>& lenSeqs) {
    int numAtoms = W_1.size();
}
...
#pragma omp parallel for
        ...
        for (int n = 0; n < numSeq; n++) 
            viterbi_search (W_1[n], W_2[n], Y[n], C[n], rho, allSeqs[n]);

        // 2b. Subprogram: 
        proximal (W_1, W_2, Y, rho, allSeqs, lenSeqs);
